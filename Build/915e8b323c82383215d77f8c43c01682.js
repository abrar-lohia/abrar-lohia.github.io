...
var ASM_CONSTS = {
  3023692: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3023747: function($0) {performance.now = function() { return $0; };},  
 3023795: function($0) {performance.now = function() { return $0; };},  
 3023843: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3023898: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3023959: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3024023: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _InitFilePicker() {
      ...
      if (!document.getElementById('ImageUploaderInput')) {
        ...
        fileInput.onchange = function (event) {
          SendMessage('FTUProfilePanel', 'ReceiveImage', URL.createObjectURL(event.target.files[0]));
        }
  ...
  function _SendImageBase64String(platform, imageBase64, message) {
  
          var imgSrc = UTF8ToString(imageBase64);
          console.log("Base64Converted ", imgSrc);
          var link = "";
          
          console.log("Platform " + UTF8ToString(platform));
          ...
          window.receiveBase64Image(UTF8ToString(platform), imgSrc, UTF8ToString(message));
...
var asmLibraryArg = {
  "DebugOnConsole": _DebugOnConsole,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "ImageUploaderInit": _ImageUploaderInit,
  "InitFilePicker": _InitFilePicker,
  ...
  "SendImageBase64String": _SendImageBase64String,
